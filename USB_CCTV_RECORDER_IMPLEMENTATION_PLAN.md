...
**Current phase:** Phase 10 — Automatic retention and dynamic storage governor (not started)
**Overall state:** **PHASE 9 COMPLETE AND APPROVED; PHASE 10 MAY BEGIN ONLY FROM THE COMMITTED, CLEAN PHASE 9 BASELINE**
